...
ALTER TABLE `product_parameter` ADD FOREIGN KEY (`product_ID`) REFERENCES `product` (`ID`);

ALTER TABLE `product_parameter` ADD FOREIGN KEY (`parameter_ID`) REFERENCES `parameter` (`ID`);
