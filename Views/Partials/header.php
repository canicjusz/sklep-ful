<?php 
$head->css('header.css', true)->script('hamburger.js', true);
?>
  ...
  <div class="main-container-header">
    <div class="container-header">
      <div  class="menu-long">
        <div class="logo">
          <a href="<?= local_url('') ?>">
          <img src="<?= get_static("logo.png") ?>" alt="logo">
          </a>
        </div>
      ...
      <div class="menu" id="hamburger__menu">
        <a class="menu__item menu__item--left" href="<?= local_url('catalog/6') ?>">
          <span class="span_header">ŹRÓDŁA ŚWIATŁA</span>
        </a>
        <a class="menu__item" href="<?= local_url('catalog/7') ?>">
          <span class="span_header">OŚWIETLENIE WEWNETRZNE</span>
        </a>
        <a class="menu__item" href="<?= local_url('catalog/1') ?>">
          <span class="span_header">GNIAZDKA, WYŁĄCZNIKI</span>
        </a>
        <a class="menu__item" href="<?= local_url('catalog/5') ?>">
          <span class="span_header">AUTOMATYKA, STEROWANIE</span>
        </a>
        <a  class="menu__item" href="<?= local_url('catalog/8') ?>">
          <span class="span_header">ROZDZIELANIE I APARATURA</span>
        </a>
        <a class="menu__item menu__item--right" href="<?= local_url('catalog/9') ?>">
