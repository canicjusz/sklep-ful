const colorSelectors = document.querySelector("color-selector");
const priceRanges = document.querySelector("price-range");

// function toggleElementVisibility1() {
//     let x = document.getElementById("sidebar__showHide1");
...
//     let x = document.getElementById("sidebar__showHide2");
//     if (x.style.display === "block") {
...
//     let x = document.getElementById("sidebar__showHide3");
//     if (x.style.display === "block") {
...
//     let x = document.getElementById("sidebar__showHide4");
//     if (x.style.display === "block") {
...
// function toggleElementVisibility5() {
//     let x = document.getElementById("sidebar__showHide5");
//     if (x.style.display === "block") {
//         document.getElementById("changeIcon5").classList.add('plus');
//         document.getElementById("changeIcon5").classList.remove('minus');
//         if ( document.getElementById("changeIcon5").classList.contains('minus') )
//         document.getElementById("changeIcon5").classList.toggle('plus');

//         x.style.display = "none";
//     } else {
//         document.getElementById("changeIcon5").classList.add('minus');
//         document.getElementById("changeIcon5").classList.remove('plus');
//         if ( document.getElementById("changeIcon5").classList.contains('plus') )
//         document.getElementById("changeIcon5").classList.toggle('minus');
